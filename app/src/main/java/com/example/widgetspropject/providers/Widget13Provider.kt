...
class Widget13Provider : AppWidgetProvider() {
    ...
    private fun updateWidget(context: Context) {
        ...
        val component = ComponentName(context, Widget13Provider::class.java)
        val ids = manager.getAppWidgetIds(component)

        for (id in ids) {
            val views = RemoteViews(context.packageName, R.layout.widget_layout_13)
